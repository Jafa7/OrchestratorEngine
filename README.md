...
Version 1.9.2 supports the complete detached runtime on Linux, WSL, native
...
that should own completions. The installed v1.9.2 package includes provider-free
...
v1.9.2 installation check and require a `passed` report.
